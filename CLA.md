# Bidragsyteravtale (Contributor License Agreement)

**Kaupet.no — Individuell bidragsyteravtale**

> The English version of this document follows below. In case of any conflict between the Norwegian and English texts, the English version shall prevail.

Takk for at du ønsker å bidra til Kaupet.no, drevet av Happy Pixel AS («Selskapet»).

Denne bidragsyteravtalen («Avtalen») dokumenterer rettighetene som bidragsytere gir til Selskapet. Ved å sende inn en pull request eller på annen måte bidra til et repository eid eller administrert av Kaupet.no eller Happy Pixel AS, aksepterer du og samtykker til følgende vilkår og betingelser for dine nåværende og fremtidige bidrag.
...
I henhold til vilkårene i denne Avtalen gir du herved til Selskapet og til mottakere av programvare distribuert av Selskapet en varig, verdensomspennende, ikke-eksklusiv, vederlagsfri, royaltyfri, ugjenkallelig opphavsrettslisens til å reprodusere, utarbeide avledede verk av, offentlig vise, offentlig fremføre, underlisensiere og distribuere dine Bidrag og slike avledede verk.
...
Du er ikke forpliktet til å gi støtte for dine Bidrag, med mindre du selv ønsker det. Du kan tilby støtte gratis, mot betaling eller ikke i det hele tatt.

**Med mindre påkrevd av gjeldende lov eller avtalt skriftlig, leverer du dine Bidrag «SOM DE ER» UTEN GARANTIER ELLER BETINGELSER AV NOE SLAG, verken uttrykkelige eller underforståtte, inkludert uten begrensning eventuelle garantier eller betingelser om TITTEL, IKKE-KRENKELSE, SALGBARHET eller EGNETHET FOR ET BESTEMT FORMÅL.**

---

## 6. Varsling

Du samtykker til å varsle Selskapet om faktiske forhold eller omstendigheter du blir kjent med, som vil gjøre disse erklæringene unøyaktige på noe punkt.

---

## 7. Gjeldende lov

Denne Avtalen skal reguleres av og tolkes i samsvar med norsk rett, uten hensyn til lovvalgsregler. Eventuelle tvister som oppstår under denne Avtalen skal være underlagt norske domstolers eksklusive jurisdiksjon.

---

_Denne bidragsyteravtalen er basert på Apache Individual Contributor License Agreement v2.0, tilpasset for Kaupet.no og Happy Pixel AS._
...
**Happy Pixel AS — Individual Contributor License Agreement**

Thank you for your interest in contributing to Kaupet.no, operated by Happy Pixel AS ("Company").

This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Company. By submitting a pull request or otherwise contributing to any repository owned or managed by Kaupet.no or Happy Pixel AS, you accept and agree to the following terms and conditions for your present and future contributions.
...
This Agreement shall be governed by and construed in accordance with the laws of Norway, without regard to its conflict of law provisions. Any disputes arising under this Agreement shall be subject to the exclusive jurisdiction of the courts of Norway.

---

_This CLA is based on the Apache Individual Contributor License Agreement v2.0, adapted for Kaupet.no and Happy Pixel AS._
