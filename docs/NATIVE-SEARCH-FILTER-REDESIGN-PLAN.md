...
Verifisering/statusnotat: Oversikten og tilbakeflyten er implementert uten
endring av utkast- eller søkemodell. Lint og typecheck passerer. Komponenttest
for apply/cancel/system-tilbake og native gest-/fokusverifisering gjenstår til
fase 7.
...
Verifisering/statusnotat: Regelbyggeren bruker forståelig ordlyd, har synlig
rediger- og fjernhandling og beholder `TermGroup`-semantikken. Lint, typecheck
og den relevante valgflatetesten passerer. Round-trip og native enhets-QA er
ikke manuelt verifisert.
...
| ---------- | ----- | ----------- | ------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| 2026-08-13 | Codex | Review-fiks | Ferdig i kode | Rettet døde oversiktsvalg, ekte seksjonsvisning, direkte primærfilter, verdioppsummering og lokal valg-draft. | Lint, typecheck, 283 tester, bygg og bundlebudsjett passerer. |
...
| F-006 | 2026-08-13 | Første implementasjon returnerte oversikten før kategori-/tilstandsarkene og viste hele det gamle skjemaet som «underside». | Døde handlinger og fortsatt høy visuell tetthet.             | Rendrer overlays felles og kun én aktiv seksjon; la til regresjonstester.        | Løst                 |
| F-007 | 2026-08-13 | `NativeChoiceSheet` skrev valg direkte selv når flaten hadde «Bruk valg».                                                   | Lukking/cancel kunne ikke forkaste lokale valg.              | Lokal draft remountes ved åpning og committes bare med «Bruk valg».              | Løst                 |
...
| ---------- | ----------- | ----------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| 2026-08-13 | Review-fiks | `bun run lint`; `bunx tsc --noEmit`; `bun run test`; `bun run build`; `bun run check:bundle`          | 51 testfiler / 283 tester, lint, typecheck, bygg og bundlebudsjett passerer. | Manuell native-/skjermleser-QA er fortsatt ikke utført.                                       |
