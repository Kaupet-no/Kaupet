...
export function NativeAdvancedSearch({
  ...
  // The Sheet (editingGroup) is a separate Radix Dialog that portals after
  // this one mounts, so it stacks above the panel below despite both using
  // z-[10000] — Radix appends nested dialog portals in mount order.
  return (
    <>
      ...
      {/* Term group sheet — its own Radix Dialog, stacks above the panel above
          since it only mounts (and portals) once the user opens it */}
      <TermGroupSheet
        group={editingGroup}
