...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // z-[10001]: one above Dialog/Sheet's z-[10000] (see ui/dialog.tsx,
      // ui/sheet.tsx) — an AlertDialog confirming an action from inside one
      // of those (e.g. bulk-import's "Bekreft oppretting") must render above
      // its parent's own backdrop, or the confirm button is visible but
      // unclickable, sitting behind the parent overlay.
