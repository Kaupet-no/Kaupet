...
export const BUSINESS_PLANS = {
  proff_basis: {
    ...
    features: [
      ...
      {
        label: "Masseopprettelse med Excel/CSV",
        included: false,
  ...
  proff: {
    ...
    trialText: "30 dager gratis, deretter 1 490 kr per måned",
    features: [
      ...sharedFeatures,
      ...
      { label: "Masseopprettelse med Excel/CSV", included: true, note: "Kommer senere." },
