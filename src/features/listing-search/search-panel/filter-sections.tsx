...
export function SearchFilterSections({
  ...
  const overview = (
    <div className="flex-1 overflow-y-auto px-4 py-5 pb-[calc(6rem+var(--safe-area-inset-bottom,env(safe-area-inset-bottom,0px)))]">
  ...
  return (
    <>
      {expanded ? (
        ...
        <div className="@container flex-1 overflow-y-auto px-4 py-5 pb-[calc(6rem+var(--safe-area-inset-bottom,env(safe-area-inset-bottom,0px)))]">
          <button
            type="button"
