  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-10 text-sm leading-relaxed text-foreground/90">
        <section>
          <p>
            Disse vilkårene gjelder for all bruk av Kaupet.no. Ved å opprette en konto eller bruke
            tjenesten godtar du vilkårene. Les dem nøye — de inneholder viktig informasjon om dine
        ...
        <section>
          ...
          <ul className="mt-3 space-y-2 list-disc pl-5">
            ...
            <li>
              ...
              kontoen din regnes som din egen.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            mellom partene, og Kaupet er ikke ansvarlig for gjennomføringen av handelen. Vi
            anbefaler:
          </p>
          <ul className="mt-3 space-y-2 list-disc pl-5">
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            en vederlagsfri, ikke-eksklusiv lisens til å lagre, vise og distribuere innholdet på
            tjenesten så lenge annonsen er publisert. Innhold du publiserer må ikke krenke
        ...
        <section>
          ...
          <p className="mt-3">
            Kaupet kan, etter eget skjønn, fjerne annonser og meldinger, skjule innhold, midlertidig
            suspendere eller permanent utestenge brukere og IP-adresser ved brudd på vilkårene. Ved
            alvorlige eller gjentatte brudd kan dette skje uten forhåndsvarsel.
            Moderasjonshandlinger logges internt.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            Tjenesten leveres "som den er". Kaupet garanterer ikke uavbrutt drift, og vi kan når som
            helst endre, begrense eller avvikle funksjoner uten forhåndsvarsel.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            tjenester som omsettes mellom brukere, eller for indirekte tap som måtte oppstå som
            følge av bruk av tjenesten. Denne begrensningen gjelder så langt loven tillater.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            Du kan be om sletting av kontoen din fra profilsiden. Slettingen har 7 dagers angrefrist
        ...
        <section>
          ...
          <p className="mt-3">
            Kaupet kan oppdatere disse vilkårene. Vesentlige endringer varsles på nettsiden.
            Fortsatt bruk av tjenesten etter at endringer er publisert regnes som aksept av de nye
            vilkårene.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            ...
            lykkes, er Oslo tingrett verneting. Forbrukere kan også klage til{" "}
            <a
        ...
        <section id="kjopsvilkar" className="scroll-mt-24">
          ...
          <ul className="mt-3 space-y-2 list-disc pl-5">
            ...
            <li>
              ...
              — om flere annonser har aktiv fremheving, velges to tilfeldig per visning. Tjenesten
              gis for valgt antall dager (3 eller 5).
            </li>
            <li>
              <strong>Pris:</strong> Gjeldende pris vises i kjøpsdialogen før betaling, og er i
              norske kroner.
            </li>
            <li>
            ...
            <li>
              <strong>Angrerett:</strong> Tjenesten er digitalt innhold som leveres umiddelbart. Du
              må samtykke i kjøpsdialogen til at leveringen starter med en gang og at angreretten
              dermed bortfaller, jf. angrerettloven § 22 bokstav n.
            </li>
            <li>
              ...
              annonsen til solgt, deaktiverer eller sletter den i fremhevingsperioden, refunderes
              ikke kjøpet.
            </li>
            <li>
              <strong>Reklamasjon og kontakt:</strong> Henvendelser om kjøpet rettes til
              kontaktadressen oppgitt i{" "}
              <Link to="/personvern" className="underline hover:text-foreground">
                personvernerklæringen
              </Link>
              .
